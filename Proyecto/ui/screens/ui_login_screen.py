...
class Ui_login_screen(object):
    def setupUi(self, login_screen):
        ...
        login_screen.setMinimumSize(QtCore.QSize(400, 300))
        login_screen.setMaximumSize(QtCore.QSize(400, 300))
        login_screen.setWindowTitle("ArchiBox - Login")
        self.access = QtWidgets.QPushButton(login_screen)
        self.access.setGeometry(QtCore.QRect(140, 230, 120, 30))
        font = QtGui.QFont()
        ...
        self.email_in.setGeometry(QtCore.QRect(10, 120, 381, 31))
        self.email_in.setObjectName("email_in")
        self.Bienvenida = QtWidgets.QLabel(login_screen)
        self.Bienvenida.setGeometry(QtCore.QRect(10, 20, 380, 71))
        font = QtGui.QFont()
        font.setFamily("Mononoki Nerd Font Mono")
        ...
        self.email_ask.setGeometry(QtCore.QRect(20, 90, 71, 31))
        font = QtGui.QFont()
        font.setFamily("Mononoki Nerd Font Mono")
        ...
        self.password_ask_2.setGeometry(QtCore.QRect(20, 160, 121, 31))
        font = QtGui.QFont()
        font.setFamily("Mononoki Nerd Font Mono")
        font.setPointSize(14)
        ...
        self.password_in.setGeometry(QtCore.QRect(10, 190, 381, 31))
        self.password_in.setObjectName("password_in")
        self.err_display = QtWidgets.QLabel(login_screen)
        self.err_display.setGeometry(QtCore.QRect(10, 280, 381, 16))
        font = QtGui.QFont()
        font.setFamily("Mononoki Nerd Font Mono")
    ...
    def retranslateUi(self, login_screen):
        ...
        self.Bienvenida.setText(_translate("login_screen", "¡Bienvenido al sistema ArchiBox!"))
