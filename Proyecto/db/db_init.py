...
if __name__ == "__main__":
    ...
    roles = [
        ...
        Rol(
            nombre="Revisor",
            descripcion="Revisa que el estado físico de los libros sea aceptable",
        ),
        Rol(
            nombre="Restaurador",
            descripcion="Mejora la condición física de lol libros que lo requieren",
        ),
        Rol(
            nombre="Digitalizador",
            descripcion="Escanéa los libros para convertirlos a formato digital",
        ),
        Rol(
            nombre="Supervisor de calidad",
            descripcion="Revisa que la digitalización del libro cumpla con etándares de calidad",
        ),
        Rol(
            nombre="Clasificador",
            descripcion="Encargado de clasificar un libro por su temática",
        ),
    ...
    estados_libro = [
        ...
        EstadoLibro(
            nombre="Registrado",
            descripcion="Se ha almacenado la información inicial del libro en el sistema",
            orden=2,
        ),
        EstadoLibro(
            nombre="En revisión física",
            descripcion="El revisor está tomando registro del estado físico del libro",
            orden=3,
        ),
        EstadoLibro(
            nombre="Aprobado de revisión física",
            descripcion="El libro cumple con los estándares de calidad en su estado físico",
            orden=4,
        ),
        EstadoLibro(
            nombre="En restauración",
            descripcion="El libro se encuentra en reparación física",
            orden=5,
        ),
        EstadoLibro(
            nombre="Restaurado",
            descripcion="La restauración ha sido completada y se espera aprobar la revisión de calidad",
            orden=6,
        ),
        EstadoLibro(
            nombre="En digitalización",
            descripcion="El libro se encuentra siendo escaneado",
            orden=7,
        ),
        EstadoLibro(
            nombre="Digitalizado",
            descripcion="El libro ha sido completamente escaneado",
            orden=8,
        ),
        EstadoLibro(
            nombre="En control de calidad",
            descripcion="El supervisor de calidad esta revisando la calidad de la digitalización",
            orden=9,
        ),
        EstadoLibro(
            nombre="Aprobado por control de calidad",
            descripcion="El libro ha sido digitalizado a plenitud",
            orden=10,
        ),
        EstadoLibro(
            nombre="En clasificación",
            descripcion="El libro se encuentra siendo clasificado por su temática",
            orden=11,
        ),
        EstadoLibro(
            nombre="Clasificado",
            descripcion="Una clasificación apropiada ha sido agregada a el libro",
            orden=12,
        ),
        EstadoLibro(
            nombre="Publicado",
            descripcion="El libro está disponible para ser descargado por los lectores",
            orden=13,
        ),
        EstadoLibro(
            nombre="Almacenado",
            descripcion="El libro ha sido llevado a un estante para ser almacenado definitivamente",
            orden=14,
        ),
    ]
