...
class TestRegisterConditionScreen(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher_msgbox = patch("use_cases.CU02_register_condition_screen.QMessageBox.information")
        ...
        self.patcher_historial = patch("use_cases.CU02_register_condition_screen.write_to_historial")
    ...
    def test_registrar_revision_exito(self):
        ...
        self.mock_session.query.return_value.filter_by.return_value.first.side_effect = [mock_estado, MagicMock(id=999)]
