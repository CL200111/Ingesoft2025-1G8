...
class TestChangePasswordScreen(unittest.TestCase):
    def setUp(self):
        ...
        # Patch QMessageBox
        self.messagebox_info = patch(
            "use_cases.CU20_change_password_screen.QMessageBox.information"
        ).start()
    ...
    def test_empty_fields(self):
        ...
        self.assertEqual(
            self.ui.errorLabel.text(), "Todos los campos son obligatorios."
        )
    ...
    def test_invalid_current_password(self):
        ...
        self.screen._handle_password_change()
        self.assertEqual(
            self.ui.errorLabel.text(), "La contraseña actual es incorrecta."
        )
    ...
    def test_passwords_do_not_match(self):
        ...
        self.screen._handle_password_change()
        self.assertEqual(
            self.ui.errorLabel.text(), "Las nuevas contraseñas no coinciden."
        )
    ...
    def test_successful_password_change(
        ...
        self.messagebox_info.assert_called_once_with(
            self.screen, "Éxito", "Contraseña actualizada correctamente."
        )
