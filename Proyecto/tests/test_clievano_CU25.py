...
class TestCreateCategoryScreen(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher_session = patch('CU25_create_category_screen.session', self.mock_session)
    ...
    def test_crear_categoria_campos_vacios(self):
        ...
        self.screen.ui.errorLabel.setText.assert_called_with("El nombre de la categoría es obligatorio.")
    ...
    def test_crear_categoria_nombre_largo(self):
        ...
        self.screen.ui.errorLabel.setText.assert_called_with("El nombre no puede exceder los 100 caracteres.")
        self.mock_session.add.assert_not_called()
    ...
    def test_crear_categoria_error_db(self):
        ...
        self.screen.ui.errorLabel.setText.assert_called_with(
            f"Error al crear la categoría: Error de DB"
        )
