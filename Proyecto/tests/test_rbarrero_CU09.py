...
class TestCreateUserScreen(unittest.TestCase):
    ...
    def test_create_user_success(self, mock_session, mock_hash, mock_log, mock_msgbox, mock_lookup):
        ...
        mock_msgbox.assert_called_with(self.window, "Éxito", "Usuario creado exitosamente")
    ...
    def test_create_user_duplicate_email(self, mock_session, mock_warning, mock_lookup):
        ...
        mock_session.query.return_value.filter_by.return_value.first.return_value = mock_existing_user
        ...
        self.window.ui.errorLabel.setText.assert_called_with("Ya existe un usuario con ese correo electrónico.")
